  ...
  return (
    <>
      <div>
        ...
        {categories.length > 0 && (
          <div className="grid w-full grid-cols-2 grid-rows-3 gap-3 overflow-x-scroll px-5 md:flex md:items-center md:gap-3 md:py-5 lg:justify-between [&::-webkit-scrollbar]:hidden">
